      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 16.w),
            CircleIconButton(assetPath: AppIcons.github),
            SizedBox(width: 10.w),
            CircleIconButton(assetPath: AppIcons.linkedin),
            SizedBox(width: 10.w),
            CircleIconButton(assetPath: AppIcons.gmail),
            SizedBox(width: 10.w),
            CircleIconButton(assetPath: AppIcons.hackerrank),
          ],
        ),
      ],
    );
